...
wget -O config.json https://gitee.com/bysideen/offlineDown/raw/master/v2rayScript/tproxy/configC-tproxy.json
wget -O v2ray.service https://gitee.com/bysideen/offlineDown/raw/master/v2rayScript/v2ray.service
wget -O v2ray-linux-64.zip https://gitee.com/bysideen/offlineDown/raw/master/v2rayScript/v2ray-linux-64.zip
wget -O tproxyrule.service https://gitee.com/bysideen/offlineDown/raw/master/v2rayScript/tproxy/tproxyrule.service
apt-get update
