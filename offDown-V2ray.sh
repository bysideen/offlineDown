...
wget -O caddy.zip https://raw.githubusercontent.com/GuNanHai/offlineDown/master/caddy
wget -O caddy.zip https://raw.githubusercontent.com/GuNanHai/offlineDown/master/Caddyfile
